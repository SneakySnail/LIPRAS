        ...
        switch mode
            case 'reset'
                if strcmpi(this.hg.LegendOn.Checked, 'on')
                    ...
                    lgd = legend(this.hg.UIAxes, 'show');
...
%         is box in fitresults tab
    ...
    methods
        ...
        value = (this.hg.EditMin2T.Value);
        end
        
        function value = get.Max2T(this)
        value = (this.hg.EditMax2T.Value);
        end
        ...
        set(table, 'ColumnName', colnames, ...
                ...
                'Data', data); % 2-14-26, removed setting of columnwidth since it auto updates due to callback when user changes which coefficient to constraint/unconstrain
        end
