...
javaMethodEDT('setDismissDelay', tm, 4000);
...
% 		jFrame.setLayout(javaMethod('BorderLayout', 'java.awt.BorderLayout', handles.statusbarObj));
% 		handles.statusbarObj.setBorder(BorderFactory.createEtchedBorder(EtchedBorder.LOWERED));
