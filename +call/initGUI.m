...
guidata(hObject, handles)
	...
	% Create tab group for uipanel3
	handles.tabgroup = uitabgroup('Parent', ...
		handles.uipanel16, 'tag', 'tabgroup',...
		'SelectionChangedFcn', @(hObject,eventdata)FDGUI(...
		'tabgroup_SelectionChangedFcn', hObject, ...
	...
	set(flipud(handles.uipanel17.Children), ...
		'Parent',handles.tab_setup);
