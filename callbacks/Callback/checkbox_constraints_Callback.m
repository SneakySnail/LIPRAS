...
elseif strcmpi(o.String, 'f')
    o.Parent.UserData(2) = ~o.Parent.UserData(3);
elseif strcmpi(o.String, 'w')
    o.Parent.UserData(3) = ~o.Parent.UserData(4);
elseif strcmpi(o.String,'m')
    o.Parent.UserData(4) = ~o.Parent.UserData(5);
end

setappdata(handles.uipanel3, 'constraints', o.Parent.UserData);
handles.guidata.constraints = o.Parent.UserData;
