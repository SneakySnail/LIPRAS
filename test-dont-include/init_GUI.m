...
% 	createJavaStatusBar();
	...
	function createTabs()
		...
		% create tab panels
		handles.tabpanel = uix.TabPanel('Parent', handles.uipanel3, 'Padding', 5, 'tag', 'tabpanel', 'fontsize', 11, 'tabwidth', 75, ...
				'SelectionChangedFcn', @(o, e)tabpanel_SelectionChangedFcn(o, e, guidata(o)));
		set(handles.panel_setup, 'parent', handles.tabpanel, 'title', '', 'bordertype', 'none', 'visible', 'on');
		set(handles.panel_parameters, 'parent', handles.tabpanel, 'title', '', 'bordertype', 'none', 'visible', 'on');
		set(handles.panel_results, 'parent', handles.tabpanel, 'title', '', 'bordertype', 'none', 'visible', 'on');

		set(handles.tabpanel, 'TabTitles', tabnames, 'TabEnables', {'on', 'off', 'off'});
